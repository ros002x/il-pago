const chapters = [
 ...
 {id:'cucina',label:'Cucina',image:'table-glasses',alt:'La tavolata del ristorante Il Pago apparecchiata con bicchieri e tovaglia bianca',title:'Le cose buone,<br><span class="script">da condividere.</span>',text:'La pasta fatta a mano, il calore della brace, le ricette di famiglia. Ti aspettiamo a tavola.',href:'ristorante.html',link:'Entra in cucina',position:'50% 50%'},
 ...
 {id:'territorio',label:'Territorio',image:'craco',alt:'Il borgo di Craco e la sua torre sul paesaggio lucano',title:'Ogni strada,<br><span class="script">una scoperta.</span>',text:'Rotondella, Matera, Craco. Le tracce della Magna Grecia e la natura dello Ionio: il viaggio comincia qui.',href:'territorio.html',link:'Esplora i dintorni',position:'50% 50%'}
];
